            ...
            <Grid templateColumns={{ base: "repeat(2, 1fr)", md: "repeat(3, 1fr)" }} gap={2} width={'100%'}>
                <GridItem colSpan={2} width={'100%'} p={2}>
                    ...
                    <Flex width={'full'} bg={'black'} position={'relative'} ref={playerContainer}>
                        ...
                        {/* Controls */}
                        <Flex position={'absolute'} top={{ base: "55px", md: "0" }} left={0} right={0} bottom={0} flexDirection={'column'} justifyContent={{ base: "center", md: 'space-between' }} gap={{ base: "3", md: "0" }} alignItems={'center'} zIndex={3} cursor={'pointer'}>
                                ...
                                <Flex width={'full'} alignItems={'center'} justifyContent={{ base: "space-around", md: 'space-between' }} my={2}>
                                    <Flex alignItems={'center'} gap={{ base: "5", md: "10" }}>
                                        <Flex alignItems={'center'} gap={{ base: "3", md: "5" }}>
                                            <MdReplay10 fontSize={{ base: "20", md: "30" }} color={'#f1f1f1'} cursor={'pointer'} onClick={handleFastRewind} />

                                            <Box onClick={() => setIsPlaying(!isPlaying)}>
                                                {!isPlaying ? (
                                                    <FaPlay fontSize={{ base: "26", md: "30" }} color='#f2f2f2' cursor={'pointer'} />
                                                ) : (
                                                    <FaPause fontSize={{ base: "20", md: "30" }} color='#f2f2f2' cursor={'pointer'} />
                                                )}
                                            </Box>

                                            <MdForward10 fontSize={{ base: "26", md: "30" }} color={'#f1f1f1'} cursor={'pointer'} onClick={handleFastForward} />
                                        </Flex>
                                        ...
                                        <Flex alignItems={'center'} gap={2}>
                                            <Box onClick={() => setMuted(!muted)}>
                                                {!muted ? (
                                                    <FaVolumeHigh fontSize={{ base: "20", md: "30" }} color='#f1f1f1' cursor={'pointer'} />
                                                ) : (
                                                    <FaVolumeXmark fontSize={{ base: "20", md: "30" }} color='#f1f1f1' cursor={'pointer'} />
                                                )}
                                            </Box>
